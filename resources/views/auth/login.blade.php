        ...
        <div class="w-full max-w-4xl bg-white rounded-2xl
            ...
            <section class="flex items-center bg-white">
                <div class="w-full px-7 py-8 sm:px-10 sm:py-10">
                    ...
                    @if (session('success'))
                        <div class="mb-5 rounded-lg bg-green-50 border border-green-100 px-3 py-2.5 text-xs text-green-700">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login.post') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                ...
                                class="input-field w-full h-11 px-3.5 rounded-lg border
                        ...
                        <button type="submit" class="login-button w-full h-11 rounded-lg bg-forest
                                   text-white text-xs font-semibold tracking-wide shadow-sm">
                            Masuk ke Akun
                        </button>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100 text-center">
                        <p class="text-xs text-gray-400"> Belum punya akun?
                            <a href="{{ route('register') }}"
                               class="font-semibold text-forest hover:text-moss transition">
                               Daftar sekarang
                            </a>
                        </p>
                    </div>
