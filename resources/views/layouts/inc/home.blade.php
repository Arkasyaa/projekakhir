<section id="home" class="relative min-h-screen flex items-center pt-2 overflow-hidden">
    <div class="absolute inset-0">
    <img 
      src="{{ asset('images/gunung-home.png') }}" 
      alt="Background Gunung" 
      class="w-full h-full object-cover"
    >
    <!-- Overlay Gradasi Hijau -->
    <div class="absolute inset-0 bg-gradient-to-r from-emerald-950/90 via-emerald-900/70 to-transparent"></div>
    </div>

    <div class="absolute top-1/4 right-0 w-96 h-96 bg-emerald-800/10 rounded-full blur-3xl pointer-events-none" aria-hidden="true"></div>
